...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Gor Garnish</a>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8">
                    ...
                    <p class="text-white-50">
                        ...
                        lima orang. Tujuannya adalah memasukkan bola ke gawang lawan, dengan memanipulasi bola dengan
                        kaki dan anggota tubuh lain selain tangan, kecuali posisi kiper.
                    </p>
                </div>
            </div>
        ...
        @php
            ...
            foreach ($booking as $book) {
                array_push($events, [
                    ...
                    'jam' => $book->jam,
                    'start' => Carbon::parse($book->time_from)->toIso8601String(),
                    'end' => Carbon::parse($book->time_to)->toIso8601String(),
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card py-4 h-100">
                        <div class="card-body text-center">
                            ...
                            <div class="small text-black-50">Jl. Karangtengah, Ciklapa, Kec. Kedungreja, Kab. Cilacap
                                Jawa Tengah</div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer bg-black small text-center text-white-50">
        <div class="container px-4 px-lg-5">Copyright &copy; Gor Garnish 2025</div>
    </footer>
    <!-- Bootstrap core JS-->
