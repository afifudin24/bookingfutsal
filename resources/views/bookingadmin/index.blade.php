...
@section('content')
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="card">
        ...
        <h3 class="card-title">Data Booking {{$pembayaran }}</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
      ...
      @endif
          <a class="btn btn-primary" href="{{url('/bookingadmin/createOffline')}}">Tambah Pesanan</a>
          <div class="row pb-3">
            <div class="col-md-3">
  ...
  @endif
        ...
        <i class="bx bx-edit-alt me-2"></i> Tampilkan</a>
        <input type="submit" class="mx-2 btn btn-danger btn-sm" value="Hapus">
        </div>
        </div>
        </form>
      ...
      <input style="display: none;" type="text" hidden name="id" value="{{ $item->id }}"
      class="form-control">
      <input style="display: none;" type="text" hidden name="status" value="Reject"
      class="form-control">
    ...
    @endif
      ...
      <input style="display: none;" type="text" hidden name="id" value="{{ $item->id }}"
      class="form-control">
      <input style="display: none;" type="text" hidden name="status" value="Selesai"
      class="form-control">
